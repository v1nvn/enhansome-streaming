## Awesome Streaming  [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 436,152 | 🐛 68 | 📅 2026-01-28 [![Build Status](https://github.com/manuzhang/awesome-streaming/workflows/build/badge.svg)](https://github.com/manuzhang/awesome-streaming/actions) ⭐ 2,952 | 🐛 5 | 📅 2025-07-24

A curated list of awesome [streaming (stream processing)](http://radar.oreilly.com/2015/08/the-world-beyond-batch-streaming-101.html) frameworks, applications, readings and other resources. Inspired by [other awesome projects](https://github.com/sindresorhus/awesome) ⭐ 436,152 | 🐛 68 | 📅 2026-01-28.
...
* [Pathway](https://github.com/pathwaycom/pathway) ⭐ 59,287 | 🐛 31 | 🌐 Python | 📅 2026-02-06 \[Python] - The fastest data processing engine supporting unified workflows for batch, streaming data, and LLM applications.
* [Apache Spark Streaming](https://github.com/apache/spark) ⭐ 42,781 | 🐛 236 | 🌐 Scala | 📅 2026-02-09 \[Scala] - makes it easy to build scalable fault-tolerant streaming applications.
* [Apache Flink](https://github.com/apache/flink) ⭐ 25,770 | 🐛 275 | 🌐 Java | 📅 2026-02-08 \[Java] - system for high-throughput, low-latency data stream processing that supports stateful computation, data-driven windowing semantics and iterative stream processing.
* [RisingWave](https://github.com/risingwavelabs/risingwave) ⭐ 8,775 | 🐛 1,426 | 🌐 Rust | 📅 2026-02-09 \[Rust] - A PostgreSQL-compatible streaming database that is designed to build event-driven applications, real-time ETL pipelines, continuous analytics services, and feature stores for AI applications. It excels in extracting fresh and consistent insights from real-time event streams, database CDC, and time series data within sub-seconds. It unifies streaming and batch processing, enabling users to ingest, join, and analyze both live and historical data at a cloud scale.
...
* [CocoIndex](https://github.com/cocoindex-io/cocoindex) ⭐ 6,055 | 🐛 61 | 🌐 Rust | 📅 2026-02-09 \[Rust/Python] - ETL framework to build fresh index for AI, with realtime incremental updates.
...
* [Numaflow](https://github.com/numaproj/numaflow) ⭐ 2,435 | 🐛 249 | 🌐 Rust | 📅 2026-02-09 \[Java/Python/Go/Rust] - Kubernetes native stream processing platform with language agnostic framework. Scalable and cost-efficient
...
* [Apache Ballista](https://github.com/apache/arrow-ballista) ⭐ 1,967 | 🐛 115 | 🌐 Rust | 📅 2026-02-08 \[Rust] - distributed compute platform powered by Apache Arrow.
...
* [ArkFlow](https://github.com/arkflow-rs/arkflow) ⭐ 1,248 | 🐛 27 | 🌐 Rust | 📅 2026-02-08 \[Rust] - High-performance Rust stream processing engine, providing powerful data stream processing capabilities, supporting multiple input/output sources and processors.
...
* [NebulaStream](https://github.com/nebulastream/nebulastream) ⭐ 75 | 🐛 183 | 🌐 C++ | 📅 2026-02-08 \[C++] - High-performance, general-purpose, end-to-end data-management system for cloud-edge-sensor environments.
...
* [Mediapipe](https://github.com/google/mediapipe) ⭐ 33,698 | 🐛 604 | 🌐 C++ | 📅 2026-02-04 - Cross-platform, customizable ML solutions for live and streaming media.
* [Apache Kafka Streams](https://github.com/apache/kafka) ⭐ 31,858 | 🐛 275 | 🌐 Java | 📅 2026-02-09 \[Java] - lightweight stream processing library included in Apache Kafka (since 0.10 version).
* [Akka Streams](https://github.com/akka/akka) ⭐ 13,260 | 🐛 900 | 🌐 Scala | 📅 2026-02-06 \[Scala] - stream processing library on Akka Actors.
* [Benthos](https://github.com/Jeffail/benthos) ⭐ 8,582 | 🐛 551 | 🌐 Go | 📅 2026-02-07 \[Go] - Benthos is a high performance and resilient message streaming service, able to connect various sources and sinks and perform arbitrary actions, transformations and filters on payloads
* [FastStream](https://github.com/airtai/faststream) ⭐ 4,942 | 🐛 114 | 🌐 Python | 📅 2026-02-05 \[Python] - powerful and easy-to-use Python library simplifying the process of writing producers and consumers for message queues, handling all the parsing, networking and documentation generation automatically. Supports multiple protocols such as Apache Kafka, RabbitMQ and alike.
...
* [YoMo](https://github.com/yomorun/yomo) ⭐ 1,881 | 🐛 3 | 🌐 Go | 📅 2026-02-03 \[Go] - An open source Streaming Serverless Framework for building Low-latency Geo-distributed system. YoMo Built atop [QUIC Transport Protocol](https://en.wikipedia.org/wiki/QUIC) and Functional Reactive Programming interface.
...
* [storm-crawler](https://github.com/DigitalPebble/storm-crawler) ⭐ 960 | 🐛 29 | 🌐 Java | 📅 2026-02-09 \[Java] - Web crawler SDK based on Apache Storm.
...
* [Apache StreamPipes](https://github.com/apache/incubator-streampipes) ⭐ 705 | 🐛 138 | 🌐 Java | 📅 2026-02-07 \[Java] - a self-service (Industrial) IoT toolbox to enable non-technical users to connect, analyze and explore IoT data streams.
...
* [Apache Beam](https://github.com/apache/beam) ⭐ 8,477 | 🐛 4,161 | 🌐 Java | 📅 2026-02-09 \[Java, Python, SQL, Scala, Go] - unified model and set of language-specific SDKs for defining and executing data processing workflows, and also data ingestion and integration flows, supporting Enterprise Integration Patterns (EIPs) and Domain Specific Languages (DSLs), open sourced by Google.
...
* [Apache Kafka](https://github.com/apache/kafka) ⭐ 31,858 | 🐛 275 | 🌐 Java | 📅 2026-02-09 \[Scala/Java] - distributed, partitioned, replicated commit log service, which provides the functionality of a messaging system, but with a unique design.
* [nsq](https://github.com/nsqio/nsq) ⭐ 25,927 | 🐛 73 | 🌐 Go | 📅 2025-07-13 \[Go] - realtime distributed messaging platform designed to operate at scale, handling billions of messages per day.
* [Apache RocketMQ](https://github.com/apache/rocketmq) ⭐ 22,330 | 🐛 276 | 🌐 Java | 📅 2026-02-06 \[Java] - distributed messaging and streaming platform with low latency, high performance and reliability, trillion-level capacity and flexible scalability.
* [Apache Pulsar](https://github.com/apache/incubator-pulsar) ⭐ 15,081 | 🐛 1,643 | 🌐 Java | 📅 2026-02-06 \[Java] - distributed pub-sub messaging platform with a very flexible messaging model and an intuitive client API.
* [Redpanda](https://github.com/redpanda-data/redpanda) ⭐ 11,691 | 🐛 658 | 🌐 C++ | 📅 2026-02-08 \[C++] - Redpanda is Kafka compatible, ZooKeeper-free, JVM-free and source available.
* [AutoMQ](https://github.com/AutoMQ/automq) ⭐ 9,473 | 🐛 82 | 🌐 Java | 📅 2026-02-09 \[Scala/Java] - cloud-first alternative to Kafka by decoupling durability to S3 and EBS. 100% Kafka compatible. 10x cost-effective. Autoscale in seconds. Single-digit ms latency.
* [fluvio](https://github.com/infinyon/fluvio) ⭐ 5,162 | 🐛 137 | 🌐 Rust | 📅 2026-02-05 \[Rust/WASM] - Real-time programmable data streaming platform with in-line computation capabilities.
* [RudderStack](https://github.com/rudderlabs/rudder-server) ⭐ 4,355 | 🐛 31 | 🌐 Go | 📅 2026-02-07 \[Go] - an open source customer data infrastructure (segment, mparticle alternative).
...
* [Gazette](https://github.com/gazette/core) ⭐ 784 | 🐛 24 | 🌐 Go | 📅 2026-02-06 \[golang] - Distributed streaming infrastructure built on cloud storage which makes it easy to mix and match batch and streaming paradigms.
...
* [ksqlDB](https://github.com/confluentinc/ksql) ⭐ 285 | 🐛 1,312 | 🌐 Java | 📅 2026-02-08 \[Java] - A cloud-native, source-available [database](https://ksqldb.io/) purpose-built for stream processing applications
...
* [akka](https://github.com/akka/akka) ⭐ 13,260 | 🐛 900 | 🌐 Scala | 📅 2026-02-06 \[Scala] - toolkit and runtime for building highly concurrent, distributed, and resilient message-driven application on the JVM.
* [aeron](https://github.com/real-logic/Aeron) ⭐ 8,437 | 🐛 17 | 🌐 Java | 📅 2026-02-07 \[Java/C++] - efficient reliable unicast and multicast message transport.
* [pulsar](https://github.com/quantmind/pulsar/) ⚠️ Archived \[Python] - Actor based event driven concurrent framework for Python.
* [Apache Pekko](https://github.com/apache/incubator-pekko) ⭐ 1,526 | 🐛 205 | 🌐 Scala | 📅 2026-02-09 \[Scala, Java] - Fork of Akka 2.6.x, prior to the Akka project's adoption of the Business Source License.
