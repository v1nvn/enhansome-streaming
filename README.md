## Awesome Streaming  [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 436,588 | 🐛 68 | 📅 2026-01-28 [![Build Status](https://github.com/manuzhang/awesome-streaming/workflows/build/badge.svg)](https://github.com/manuzhang/awesome-streaming/actions) ⭐ 2,953 | 🐛 5 | 📅 2026-02-09

A curated list of awesome [streaming (stream processing)](http://radar.oreilly.com/2015/08/the-world-beyond-batch-streaming-101.html) frameworks, applications, readings and other resources. Inspired by [other awesome projects](https://github.com/sindresorhus/awesome) ⭐ 436,588 | 🐛 68 | 📅 2026-01-28.
...
* [Pathway](https://github.com/pathwaycom/pathway) ⭐ 59,318 | 🐛 30 | 🌐 Python | 📅 2026-02-10 \[Python] - The fastest data processing engine supporting unified workflows for batch, streaming data, and LLM applications.
* [Apache Spark Streaming](https://github.com/apache/spark) ⭐ 42,795 | 🐛 244 | 🌐 Scala | 📅 2026-02-11 \[Scala] - makes it easy to build scalable fault-tolerant streaming applications.
* [Apache Flink](https://github.com/apache/flink) ⭐ 25,774 | 🐛 289 | 🌐 Java | 📅 2026-02-10 \[Java] - system for high-throughput, low-latency data stream processing that supports stateful computation, data-driven windowing semantics and iterative stream processing.
* [RisingWave](https://github.com/risingwavelabs/risingwave) ⭐ 8,779 | 🐛 1,432 | 🌐 Rust | 📅 2026-02-11 \[Rust] - A PostgreSQL-compatible streaming database that is designed to build event-driven applications, real-time ETL pipelines, continuous analytics services, and feature stores for AI applications. It excels in extracting fresh and consistent insights from real-time event streams, database CDC, and time series data within sub-seconds. It unifies streaming and batch processing, enabling users to ingest, join, and analyze both live and historical data at a cloud scale.
...
* [CocoIndex](https://github.com/cocoindex-io/cocoindex) ⭐ 6,063 | 🐛 60 | 🌐 Rust | 📅 2026-02-10 \[Rust/Python] - ETL framework to build fresh index for AI, with realtime incremental updates.
* [Arroyo](https://github.com/ArroyoSystems/arroyo) ⭐ 4,800 | 🐛 100 | 🌐 Rust | 📅 2026-02-10 \[Rust] - a distributed stream processing engine. Supports SQL and Rust pipelines. Scales up to millions of events per second. Supports stateful operations like windows and joins, state checkpointing for fault-tolerance and recovery of pipelines. Uses the Timely Dataflow model.
...
* [Numaflow](https://github.com/numaproj/numaflow) ⭐ 2,434 | 🐛 252 | 🌐 Rust | 📅 2026-02-11 \[Java/Python/Go/Rust] - Kubernetes native stream processing platform with language agnostic framework. Scalable and cost-efficient
...
* [Apache Ballista](https://github.com/apache/arrow-ballista) ⭐ 1,968 | 🐛 118 | 🌐 Rust | 📅 2026-02-10 \[Rust] - distributed compute platform powered by Apache Arrow.
* [Bytewax](https://github.com/bytewax/bytewax) ⭐ 1,953 | 🐛 40 | 🌐 Python | 📅 2025-03-27 \[Python] - data parallel, distributed, stateful stream processing framework.
* [Kuiper](https://github.com/emqx/kuiper) ⭐ 1,677 | 🐛 47 | 🌐 Go | 📅 2026-02-02 \[Golang] - An edge lightweight IoT data analytics/streaming software implemented by Golang, and it can be run at all kinds of resource-constrained edge devices.
...
* [NebulaStream](https://github.com/nebulastream/nebulastream) ⭐ 75 | 🐛 187 | 🌐 C++ | 📅 2026-02-11 \[C++] - High-performance, general-purpose, end-to-end data-management system for cloud-edge-sensor environments.
...
* [Mediapipe](https://github.com/google/mediapipe) ⭐ 33,735 | 🐛 604 | 🌐 C++ | 📅 2026-02-04 - Cross-platform, customizable ML solutions for live and streaming media.
* [Apache Kafka Streams](https://github.com/apache/kafka) ⭐ 31,865 | 🐛 275 | 🌐 Java | 📅 2026-02-11 \[Java] - lightweight stream processing library included in Apache Kafka (since 0.10 version).
* [Akka Streams](https://github.com/akka/akka) ⭐ 13,263 | 🐛 901 | 🌐 Scala | 📅 2026-02-10 \[Scala] - stream processing library on Akka Actors.
* [Benthos](https://github.com/Jeffail/benthos) ⭐ 8,583 | 🐛 554 | 🌐 Go | 📅 2026-02-09 \[Go] - Benthos is a high performance and resilient message streaming service, able to connect various sources and sinks and perform arbitrary actions, transformations and filters on payloads
* [FastStream](https://github.com/airtai/faststream) ⭐ 4,953 | 🐛 113 | 🌐 Python | 📅 2026-02-11 \[Python] - powerful and easy-to-use Python library simplifying the process of writing producers and consumers for message queues, handling all the parsing, networking and documentation generation automatically. Supports multiple protocols such as Apache Kafka, RabbitMQ and alike.
...
* [Zilla](https://github.com/aklivity/zilla) ⭐ 676 | 🐛 171 | 🌐 Java | 📅 2026-02-10 \[Java] - Cross-platform, API gateway built for event-driven architectures and streaming that supports standard protocols such as HTTP, SSE, gRPC, MQTT and the native Kafka protocol.
...
* [Apache StreamPipes](https://github.com/apache/incubator-streampipes) ⭐ 707 | 🐛 148 | 🌐 Java | 📅 2026-02-11 \[Java] - a self-service (Industrial) IoT toolbox to enable non-technical users to connect, analyze and explore IoT data streams.
...
* [Apache Beam](https://github.com/apache/beam) ⭐ 8,483 | 🐛 4,158 | 🌐 Java | 📅 2026-02-11 \[Java, Python, SQL, Scala, Go] - unified model and set of language-specific SDKs for defining and executing data processing workflows, and also data ingestion and integration flows, supporting Enterprise Integration Patterns (EIPs) and Domain Specific Languages (DSLs), open sourced by Google.
...
* [Apache Kafka](https://github.com/apache/kafka) ⭐ 31,865 | 🐛 275 | 🌐 Java | 📅 2026-02-11 \[Scala/Java] - distributed, partitioned, replicated commit log service, which provides the functionality of a messaging system, but with a unique design.
...
* [Apache RocketMQ](https://github.com/apache/rocketmq) ⭐ 22,333 | 🐛 285 | 🌐 Java | 📅 2026-02-11 \[Java] - distributed messaging and streaming platform with low latency, high performance and reliability, trillion-level capacity and flexible scalability.
* [Apache Pulsar](https://github.com/apache/incubator-pulsar) ⭐ 15,085 | 🐛 1,639 | 🌐 Java | 📅 2026-02-10 \[Java] - distributed pub-sub messaging platform with a very flexible messaging model and an intuitive client API.
* [Redpanda](https://github.com/redpanda-data/redpanda) ⭐ 11,708 | 🐛 662 | 🌐 C++ | 📅 2026-02-11 \[C++] - Redpanda is Kafka compatible, ZooKeeper-free, JVM-free and source available.
* [AutoMQ](https://github.com/AutoMQ/automq) ⭐ 9,484 | 🐛 85 | 🌐 Java | 📅 2026-02-11 \[Scala/Java] - cloud-first alternative to Kafka by decoupling durability to S3 and EBS. 100% Kafka compatible. 10x cost-effective. Autoscale in seconds. Single-digit ms latency.
* [fluvio](https://github.com/infinyon/fluvio) ⭐ 5,164 | 🐛 137 | 🌐 Rust | 📅 2026-02-10 \[Rust/WASM] - Real-time programmable data streaming platform with in-line computation capabilities.
* [RudderStack](https://github.com/rudderlabs/rudder-server) ⭐ 4,355 | 🐛 30 | 🌐 Go | 📅 2026-02-10 \[Go] - an open source customer data infrastructure (segment, mparticle alternative).
...
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,382 | 🐛 18 | 🌐 Python | 📅 2026-02-10 \[Python] - CLI tool to copy data between any source and destination with a single command. Supports 50+ connectors including databases, SaaS apps, and data warehouses.
...
* [Bruin](https://github.com/bruin-data/bruin) ⭐ 1,362 | 🐛 37 | 🌐 Go | 📅 2026-02-10 \[Go] - End-to-end data pipeline tool combining ingestion from 50+ sources, SQL/Python transformations, and built-in data quality checks in a single CLI.
...
* [River](https://github.com/online-ml/river) ⭐ 5,705 | 🐛 116 | 🌐 Python | 📅 2026-02-09 \[Python] - online machine learning library.
* [DataSketches](https://github.com/DataSketches/sketches-core) ⭐ 945 | 🐛 8 | 🌐 Java | 📅 2026-02-11 \[Java] - sketches library from Yahoo!.
...
* [Proton](https://github.com/timeplus-io/proton) ⭐ 2,134 | 🐛 90 | 🌐 C++ | 📅 2026-02-10 \[C++] - A unified streaming and historical data analytics database in a single binary, powered by ClickHouse.
...
* [ksqlDB](https://github.com/confluentinc/ksql) ⭐ 287 | 🐛 1,312 | 🌐 Java | 📅 2026-02-11 \[Java] - A cloud-native, source-available [database](https://ksqldb.io/) purpose-built for stream processing applications
...
* [akka](https://github.com/akka/akka) ⭐ 13,263 | 🐛 901 | 🌐 Scala | 📅 2026-02-10 \[Scala] - toolkit and runtime for building highly concurrent, distributed, and resilient message-driven application on the JVM.
* [aeron](https://github.com/real-logic/Aeron) ⭐ 8,442 | 🐛 17 | 🌐 Java | 📅 2026-02-07 \[Java/C++] - efficient reliable unicast and multicast message transport.
...
* [Nussknacker](https://github.com/TouK/nussknacker) ⭐ 709 | 🐛 67 | 🌐 Scala | 📅 2026-02-10 \[Scala] - A visual tool to define and run real-time decision algorithms.
