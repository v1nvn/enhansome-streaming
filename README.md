## Awesome Streaming  [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 437,495 | 🐛 70 | 📅 2026-01-28 [![Build Status](https://github.com/manuzhang/awesome-streaming/workflows/build/badge.svg)](https://github.com/manuzhang/awesome-streaming/actions) ⭐ 2,953 | 🐛 5 | 📅 2026-02-09

A curated list of awesome [streaming (stream processing)](http://radar.oreilly.com/2015/08/the-world-beyond-batch-streaming-101.html) frameworks, applications, readings and other resources. Inspired by [other awesome projects](https://github.com/sindresorhus/awesome) ⭐ 437,495 | 🐛 70 | 📅 2026-01-28.
...
* [Pathway](https://github.com/pathwaycom/pathway) ⭐ 59,482 | 🐛 30 | 🌐 Python | 📅 2026-02-13 \[Python] - The fastest data processing engine supporting unified workflows for batch, streaming data, and LLM applications.
* [Apache Spark Streaming](https://github.com/apache/spark) ⭐ 42,814 | 🐛 257 | 🌐 Scala | 📅 2026-02-14 \[Scala] - makes it easy to build scalable fault-tolerant streaming applications.
* [Apache Flink](https://github.com/apache/flink) ⭐ 25,793 | 🐛 310 | 🌐 Java | 📅 2026-02-13 \[Java] - system for high-throughput, low-latency data stream processing that supports stateful computation, data-driven windowing semantics and iterative stream processing.
* [RisingWave](https://github.com/risingwavelabs/risingwave) ⭐ 8,792 | 🐛 1,429 | 🌐 Rust | 📅 2026-02-14 \[Rust] - A PostgreSQL-compatible streaming database that is designed to build event-driven applications, real-time ETL pipelines, continuous analytics services, and feature stores for AI applications. It excels in extracting fresh and consistent insights from real-time event streams, database CDC, and time series data within sub-seconds. It unifies streaming and batch processing, enabling users to ingest, join, and analyze both live and historical data at a cloud scale.
* [Faust](https://github.com/robinhood/faust) ⭐ 6,836 | 🐛 277 | 🌐 Python | 📅 2024-07-27 \[Python] - stream processing library, porting the ideas from Kafka Streams to Python
* [Apache Storm](https://github.com/apache/storm) ⭐ 6,670 | 🐛 41 | 🌐 Java | 📅 2026-02-04 \[Clojure/Java] - distributed real-time computation system. Storm is to stream processing what Hadoop is to batch processing.
* [CocoIndex](https://github.com/cocoindex-io/cocoindex) ⭐ 6,091 | 🐛 61 | 🌐 Rust | 📅 2026-02-15 \[Rust/Python] - ETL framework to build fresh index for AI, with realtime incremental updates.
* [Arroyo](https://github.com/ArroyoSystems/arroyo) ⭐ 4,810 | 🐛 100 | 🌐 Rust | 📅 2026-02-11 \[Rust] - a distributed stream processing engine. Supports SQL and Rust pipelines. Scales up to millions of events per second. Supports stateful operations like windows and joins, state checkpointing for fault-tolerance and recovery of pipelines. Uses the Timely Dataflow model.
...
* [Numaflow](https://github.com/numaproj/numaflow) ⭐ 2,435 | 🐛 255 | 🌐 Rust | 📅 2026-02-15 \[Java/Python/Go/Rust] - Kubernetes native stream processing platform with language agnostic framework. Scalable and cost-efficient
...
* [Apache Ballista](https://github.com/apache/arrow-ballista) ⭐ 1,970 | 🐛 114 | 🌐 Rust | 📅 2026-02-12 \[Rust] - distributed compute platform powered by Apache Arrow.
* [Bytewax](https://github.com/bytewax/bytewax) ⭐ 1,955 | 🐛 40 | 🌐 Python | 📅 2025-03-27 \[Python] - data parallel, distributed, stateful stream processing framework.
* [Kuiper](https://github.com/emqx/kuiper) ⭐ 1,678 | 🐛 48 | 🌐 Go | 📅 2026-02-02 \[Golang] - An edge lightweight IoT data analytics/streaming software implemented by Golang, and it can be run at all kinds of resource-constrained edge devices.
...
* [mantis](https://github.com/Netflix/mantis) ⭐ 1,458 | 🐛 81 | 🌐 Java | 📅 2026-02-13 \[Java] - Netflix's platform to build an ecosystem of realtime stream processing applications
...
* [ArkFlow](https://github.com/arkflow-rs/arkflow) ⭐ 1,249 | 🐛 27 | 🌐 Rust | 📅 2026-02-13 \[Rust] - High-performance Rust stream processing engine, providing powerful data stream processing capabilities, supporting multiple input/output sources and processors.
...
* [Apache Samza](https://github.com/apache/samza) ⭐ 838 | 🐛 41 | 🌐 Java | 📅 2025-05-02 \[Scala/Java] - distributed stream processing framework that build on Kafka(messaging, storage) and YARN(fault tolerance, processor isolation, security and resource management).
* [Gearpump](https://github.com/gearpump/gearpump) ⭐ 759 | 🐛 97 | 🌐 Scala | 📅 2022-03-01 \[Scala] - lightweight real-time distributed streaming engine built on Akka.
...
* [NebulaStream](https://github.com/nebulastream/nebulastream) ⭐ 75 | 🐛 203 | 🌐 C++ | 📅 2026-02-15 \[C++] - High-performance, general-purpose, end-to-end data-management system for cloud-edge-sensor environments.
...
* [Mediapipe](https://github.com/google/mediapipe) ⭐ 33,778 | 🐛 606 | 🌐 C++ | 📅 2026-02-04 - Cross-platform, customizable ML solutions for live and streaming media.
* [Apache Kafka Streams](https://github.com/apache/kafka) ⭐ 31,898 | 🐛 278 | 🌐 Java | 📅 2026-02-15 \[Java] - lightweight stream processing library included in Apache Kafka (since 0.10 version).
* [Akka Streams](https://github.com/akka/akka) ⭐ 13,263 | 🐛 903 | 🌐 Scala | 📅 2026-02-14 \[Scala] - stream processing library on Akka Actors.
* [Benthos](https://github.com/Jeffail/benthos) ⭐ 8,587 | 🐛 560 | 🌐 Go | 📅 2026-02-15 \[Go] - Benthos is a high performance and resilient message streaming service, able to connect various sources and sinks and perform arbitrary actions, transformations and filters on payloads
* [FastStream](https://github.com/airtai/faststream) ⭐ 4,955 | 🐛 113 | 🌐 Python | 📅 2026-02-11 \[Python] - powerful and easy-to-use Python library simplifying the process of writing producers and consumers for message queues, handling all the parsing, networking and documentation generation automatically. Supports multiple protocols such as Apache Kafka, RabbitMQ and alike.
...
* [FS2(prev. 'Scalaz-Stream')](https://github.com/functional-streams-for-scala/fs2) ⭐ 2,440 | 🐛 131 | 🌐 Scala | 📅 2026-02-15 \[Scala] - Compositional, streaming I/O library for Scala.
...
* [YoMo](https://github.com/yomorun/yomo) ⭐ 1,880 | 🐛 3 | 🌐 Go | 📅 2026-02-13 \[Go] - An open source Streaming Serverless Framework for building Low-latency Geo-distributed system. YoMo Built atop [QUIC Transport Protocol](https://en.wikipedia.org/wiki/QUIC) and Functional Reactive Programming interface.
* [Quix Streams](https://github.com/quixio/quix-streams) ⭐ 1,519 | 🐛 22 | 🌐 Python | 📅 2026-02-13 \[Python] - a streaming library originally designed for the McLaren Formula 1 racing team that can process high volumes of time-series data with up to nanosecond precision using Apache Kafka as a message broker.
* [Streamz](https://github.com/python-streamz/streamz) ⭐ 1,291 | 🐛 120 | 🌐 Python | 📅 2026-02-05 \[Python] - A lightweight library for building pipelines to manage continuous streams of data; supports complex pipelines that involve branching, joining, flow control, feedback, back pressure, and so on.
* [Streamiz](https://github.com/LGouellec/kafka-streams-dotnet) ⭐ 527 | 🐛 25 | 🌐 C# | 📅 2026-01-26 \[C#] - a .Net Stream Processing Library for Apache Kafka
...
* [Substation](https://github.com/brexhq/substation) ⭐ 389 | 🐛 1 | 🌐 Go | 📅 2026-01-20 \[Go] - Substation is a cloud native data pipeline and transformation toolkit written in Go.
...
* [storm-crawler](https://github.com/DigitalPebble/storm-crawler) ⭐ 964 | 🐛 29 | 🌐 Java | 📅 2026-02-09 \[Java] - Web crawler SDK based on Apache Storm.
* [Zilla](https://github.com/aklivity/zilla) ⭐ 677 | 🐛 170 | 🌐 Java | 📅 2026-02-13 \[Java] - Cross-platform, API gateway built for event-driven architectures and streaming that supports standard protocols such as HTTP, SSE, gRPC, MQTT and the native Kafka protocol.
* [straw](https://github.com/rwalk/straw) ⭐ 102 | 🐛 2 | 🌐 Python | 📅 2016-03-09 \[Python/Java] - A platform for real-time streaming search.
* [javactrl-kafka](https://github.com/javactrl/javactrl-kafka) ⭐ 16 | 🐛 5 | 🌐 Java | 📅 2025-04-30 \[Java] - An application of a stateful stream processing for workflow as Java code (microservices orchestration, business process automation, and more).

### IoT

* [Apache StreamPipes](https://github.com/apache/incubator-streampipes) ⭐ 711 | 🐛 140 | 🌐 Java | 📅 2026-02-13 \[Java] - a self-service (Industrial) IoT toolbox to enable non-technical users to connect, analyze and explore IoT data streams.
...
* [Apache Beam](https://github.com/apache/beam) ⭐ 8,486 | 🐛 4,174 | 🌐 Java | 📅 2026-02-14 \[Java, Python, SQL, Scala, Go] - unified model and set of language-specific SDKs for defining and executing data processing workflows, and also data ingestion and integration flows, supporting Enterprise Integration Patterns (EIPs) and Domain Specific Languages (DSLs), open sourced by Google.
...
* [Esper](https://github.com/espertechinc/esper) ⭐ 875 | 🐛 16 | 🌐 Java | 📅 2024-04-26 \[Java] - component for complex event processing (CEP) and event series analysis.
...
* [Apache Kafka](https://github.com/apache/kafka) ⭐ 31,898 | 🐛 278 | 🌐 Java | 📅 2026-02-15 \[Scala/Java] - distributed, partitioned, replicated commit log service, which provides the functionality of a messaging system, but with a unique design.
* [nsq](https://github.com/nsqio/nsq) ⭐ 25,920 | 🐛 74 | 🌐 Go | 📅 2025-07-13 \[Go] - realtime distributed messaging platform designed to operate at scale, handling billions of messages per day.
* [Apache RocketMQ](https://github.com/apache/rocketmq) ⭐ 22,333 | 🐛 279 | 🌐 Java | 📅 2026-02-13 \[Java] - distributed messaging and streaming platform with low latency, high performance and reliability, trillion-level capacity and flexible scalability.
* [Apache Pulsar](https://github.com/apache/incubator-pulsar) ⭐ 15,088 | 🐛 1,644 | 🌐 Java | 📅 2026-02-13 \[Java] - distributed pub-sub messaging platform with a very flexible messaging model and an intuitive client API.
* [Redpanda](https://github.com/redpanda-data/redpanda) ⭐ 11,723 | 🐛 668 | 🌐 C++ | 📅 2026-02-13 \[C++] - Redpanda is Kafka compatible, ZooKeeper-free, JVM-free and source available.
* [AutoMQ](https://github.com/AutoMQ/automq) ⭐ 9,503 | 🐛 84 | 🌐 Java | 📅 2026-02-13 \[Scala/Java] - cloud-first alternative to Kafka by decoupling durability to S3 and EBS. 100% Kafka compatible. 10x cost-effective. Autoscale in seconds. Single-digit ms latency.
* [fluvio](https://github.com/infinyon/fluvio) ⭐ 5,167 | 🐛 139 | 🌐 Rust | 📅 2026-02-14 \[Rust/WASM] - Real-time programmable data streaming platform with in-line computation capabilities.
* [RudderStack](https://github.com/rudderlabs/rudder-server) ⭐ 4,359 | 🐛 32 | 🌐 Go | 📅 2026-02-13 \[Go] - an open source customer data infrastructure (segment, mparticle alternative).
...
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,385 | 🐛 18 | 🌐 Python | 📅 2026-02-13 \[Python] - CLI tool to copy data between any source and destination with a single command. Supports 50+ connectors including databases, SaaS apps, and data warehouses.
...
* [Bruin](https://github.com/bruin-data/bruin) ⭐ 1,363 | 🐛 36 | 🌐 Go | 📅 2026-02-13 \[Go] - End-to-end data pipeline tool combining ingestion from 50+ sources, SQL/Python transformations, and built-in data quality checks in a single CLI.
...
* [brooklin](https://github.com/linkedin/Brooklin/) ⭐ 955 | 🐛 36 | 🌐 Java | 📅 2026-02-04 \[Java] - a distributed system intended for streaming data between various heterogeneous source and destination systems with high reliability and throughput at scale from Linkedin (replaced databus).
...
* [Gazette](https://github.com/gazette/core) ⭐ 785 | 🐛 24 | 🌐 Go | 📅 2026-02-09 \[golang] - Distributed streaming infrastructure built on cloud storage which makes it easy to mix and match batch and streaming paradigms.
...
* [River](https://github.com/online-ml/river) ⭐ 5,713 | 🐛 115 | 🌐 Python | 📅 2026-02-09 \[Python] - online machine learning library.
* [DataSketches](https://github.com/DataSketches/sketches-core) ⭐ 947 | 🐛 7 | 🌐 Java | 📅 2026-02-11 \[Java] - sketches library from Yahoo!.
...
* [Proton](https://github.com/timeplus-io/proton) ⭐ 2,135 | 🐛 90 | 🌐 C++ | 📅 2026-02-12 \[C++] - A unified streaming and historical data analytics database in a single binary, powered by ClickHouse.
* [Siddhi](https://github.com/siddhi-io/siddhi) ⭐ 1,578 | 🐛 124 | 🌐 Java | 📅 2025-08-08 \[Java] - A cloud native Streaming and Complex Event Processing engine that understands Streaming SQL queries in order to capture events from diverse data sources, process them, detect complex conditions, and publish output to various endpoints in real time.
* [ksqlDB](https://github.com/confluentinc/ksql) ⭐ 290 | 🐛 1,312 | 🌐 Java | 📅 2026-02-15 \[Java] - A cloud-native, source-available [database](https://ksqldb.io/) purpose-built for stream processing applications
...
* [akka](https://github.com/akka/akka) ⭐ 13,263 | 🐛 903 | 🌐 Scala | 📅 2026-02-14 \[Scala] - toolkit and runtime for building highly concurrent, distributed, and resilient message-driven application on the JVM.
* [aeron](https://github.com/real-logic/Aeron) ⭐ 8,446 | 🐛 16 | 🌐 Java | 📅 2026-02-07 \[Java/C++] - efficient reliable unicast and multicast message transport.
* [pulsar](https://github.com/quantmind/pulsar/) ⚠️ Archived \[Python] - Actor based event driven concurrent framework for Python.
* [Apache Pekko](https://github.com/apache/incubator-pekko) ⭐ 1,528 | 🐛 202 | 🌐 Scala | 📅 2026-02-10 \[Scala, Java] - Fork of Akka 2.6.x, prior to the Akka project's adoption of the Business Source License.
...
* [Nussknacker](https://github.com/TouK/nussknacker) ⭐ 709 | 🐛 69 | 🌐 Scala | 📅 2026-02-13 \[Scala] - A visual tool to define and run real-time decision algorithms.
