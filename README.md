## Awesome Streaming  [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 437,047 | 🐛 69 | 📅 2026-01-28 [![Build Status](https://github.com/manuzhang/awesome-streaming/workflows/build/badge.svg)](https://github.com/manuzhang/awesome-streaming/actions) ⭐ 2,953 | 🐛 5 | 📅 2026-02-09

A curated list of awesome [streaming (stream processing)](http://radar.oreilly.com/2015/08/the-world-beyond-batch-streaming-101.html) frameworks, applications, readings and other resources. Inspired by [other awesome projects](https://github.com/sindresorhus/awesome) ⭐ 437,047 | 🐛 69 | 📅 2026-01-28.
...
* [Pathway](https://github.com/pathwaycom/pathway) ⭐ 59,375 | 🐛 30 | 🌐 Python | 📅 2026-02-13 \[Python] - The fastest data processing engine supporting unified workflows for batch, streaming data, and LLM applications.
* [Apache Spark Streaming](https://github.com/apache/spark) ⭐ 42,808 | 🐛 253 | 🌐 Scala | 📅 2026-02-13 \[Scala] - makes it easy to build scalable fault-tolerant streaming applications.
* [Apache Flink](https://github.com/apache/flink) ⭐ 25,786 | 🐛 299 | 🌐 Java | 📅 2026-02-12 \[Java] - system for high-throughput, low-latency data stream processing that supports stateful computation, data-driven windowing semantics and iterative stream processing.
* [RisingWave](https://github.com/risingwavelabs/risingwave) ⭐ 8,788 | 🐛 1,432 | 🌐 Rust | 📅 2026-02-13 \[Rust] - A PostgreSQL-compatible streaming database that is designed to build event-driven applications, real-time ETL pipelines, continuous analytics services, and feature stores for AI applications. It excels in extracting fresh and consistent insights from real-time event streams, database CDC, and time series data within sub-seconds. It unifies streaming and batch processing, enabling users to ingest, join, and analyze both live and historical data at a cloud scale.
* [Faust](https://github.com/robinhood/faust) ⭐ 6,837 | 🐛 277 | 🌐 Python | 📅 2024-07-27 \[Python] - stream processing library, porting the ideas from Kafka Streams to Python
...
* [Numaflow](https://github.com/numaproj/numaflow) ⭐ 2,435 | 🐛 253 | 🌐 Rust | 📅 2026-02-13 \[Java/Python/Go/Rust] - Kubernetes native stream processing platform with language agnostic framework. Scalable and cost-efficient
...
* [Apache Ballista](https://github.com/apache/arrow-ballista) ⭐ 1,969 | 🐛 114 | 🌐 Rust | 📅 2026-02-12 \[Rust] - distributed compute platform powered by Apache Arrow.
* [Bytewax](https://github.com/bytewax/bytewax) ⭐ 1,954 | 🐛 40 | 🌐 Python | 📅 2025-03-27 \[Python] - data parallel, distributed, stateful stream processing framework.
...
* [ArkFlow](https://github.com/arkflow-rs/arkflow) ⭐ 1,249 | 🐛 27 | 🌐 Rust | 📅 2026-02-12 \[Rust] - High-performance Rust stream processing engine, providing powerful data stream processing capabilities, supporting multiple input/output sources and processors.
...
* [NebulaStream](https://github.com/nebulastream/nebulastream) ⭐ 75 | 🐛 189 | 🌐 C++ | 📅 2026-02-13 \[C++] - High-performance, general-purpose, end-to-end data-management system for cloud-edge-sensor environments.
...
* [Mediapipe](https://github.com/google/mediapipe) ⭐ 33,762 | 🐛 606 | 🌐 C++ | 📅 2026-02-04 - Cross-platform, customizable ML solutions for live and streaming media.
* [Apache Kafka Streams](https://github.com/apache/kafka) ⭐ 31,878 | 🐛 270 | 🌐 Java | 📅 2026-02-13 \[Java] - lightweight stream processing library included in Apache Kafka (since 0.10 version).
* [Akka Streams](https://github.com/akka/akka) ⭐ 13,265 | 🐛 903 | 🌐 Scala | 📅 2026-02-12 \[Scala] - stream processing library on Akka Actors.
* [Benthos](https://github.com/Jeffail/benthos) ⭐ 8,585 | 🐛 559 | 🌐 Go | 📅 2026-02-13 \[Go] - Benthos is a high performance and resilient message streaming service, able to connect various sources and sinks and perform arbitrary actions, transformations and filters on payloads
* [FastStream](https://github.com/airtai/faststream) ⭐ 4,954 | 🐛 113 | 🌐 Python | 📅 2026-02-11 \[Python] - powerful and easy-to-use Python library simplifying the process of writing producers and consumers for message queues, handling all the parsing, networking and documentation generation automatically. Supports multiple protocols such as Apache Kafka, RabbitMQ and alike.
* [StreamAlert](https://github.com/airbnb/streamalert) ⭐ 2,886 | 🐛 90 | 🌐 Python | 📅 2023-10-23 \[Python] - Airbnb's Real-time Data Analysis and Alerting.
...
* [YoMo](https://github.com/yomorun/yomo) ⭐ 1,882 | 🐛 3 | 🌐 Go | 📅 2026-02-13 \[Go] - An open source Streaming Serverless Framework for building Low-latency Geo-distributed system. YoMo Built atop [QUIC Transport Protocol](https://en.wikipedia.org/wiki/QUIC) and Functional Reactive Programming interface.
* [Quix Streams](https://github.com/quixio/quix-streams) ⭐ 1,518 | 🐛 25 | 🌐 Python | 📅 2026-02-12 \[Python] - a streaming library originally designed for the McLaren Formula 1 racing team that can process high volumes of time-series data with up to nanosecond precision using Apache Kafka as a message broker.
...
* [Zilla](https://github.com/aklivity/zilla) ⭐ 677 | 🐛 169 | 🌐 Java | 📅 2026-02-11 \[Java] - Cross-platform, API gateway built for event-driven architectures and streaming that supports standard protocols such as HTTP, SSE, gRPC, MQTT and the native Kafka protocol.
...
* [Apache StreamPipes](https://github.com/apache/incubator-streampipes) ⭐ 710 | 🐛 145 | 🌐 Java | 📅 2026-02-12 \[Java] - a self-service (Industrial) IoT toolbox to enable non-technical users to connect, analyze and explore IoT data streams.
...
* [Apache Beam](https://github.com/apache/beam) ⭐ 8,485 | 🐛 4,165 | 🌐 Java | 📅 2026-02-13 \[Java, Python, SQL, Scala, Go] - unified model and set of language-specific SDKs for defining and executing data processing workflows, and also data ingestion and integration flows, supporting Enterprise Integration Patterns (EIPs) and Domain Specific Languages (DSLs), open sourced by Google.
...
* [Apache Kafka](https://github.com/apache/kafka) ⭐ 31,878 | 🐛 270 | 🌐 Java | 📅 2026-02-13 \[Scala/Java] - distributed, partitioned, replicated commit log service, which provides the functionality of a messaging system, but with a unique design.
* [nsq](https://github.com/nsqio/nsq) ⭐ 25,925 | 🐛 74 | 🌐 Go | 📅 2025-07-13 \[Go] - realtime distributed messaging platform designed to operate at scale, handling billions of messages per day.
* [Apache RocketMQ](https://github.com/apache/rocketmq) ⭐ 22,336 | 🐛 281 | 🌐 Java | 📅 2026-02-12 \[Java] - distributed messaging and streaming platform with low latency, high performance and reliability, trillion-level capacity and flexible scalability.
* [Apache Pulsar](https://github.com/apache/incubator-pulsar) ⭐ 15,086 | 🐛 1,641 | 🌐 Java | 📅 2026-02-13 \[Java] - distributed pub-sub messaging platform with a very flexible messaging model and an intuitive client API.
* [Redpanda](https://github.com/redpanda-data/redpanda) ⭐ 11,715 | 🐛 669 | 🌐 C++ | 📅 2026-02-13 \[C++] - Redpanda is Kafka compatible, ZooKeeper-free, JVM-free and source available.
* [AutoMQ](https://github.com/AutoMQ/automq) ⭐ 9,492 | 🐛 83 | 🌐 Java | 📅 2026-02-13 \[Scala/Java] - cloud-first alternative to Kafka by decoupling durability to S3 and EBS. 100% Kafka compatible. 10x cost-effective. Autoscale in seconds. Single-digit ms latency.
* [fluvio](https://github.com/infinyon/fluvio) ⭐ 5,168 | 🐛 138 | 🌐 Rust | 📅 2026-02-11 \[Rust/WASM] - Real-time programmable data streaming platform with in-line computation capabilities.
* [RudderStack](https://github.com/rudderlabs/rudder-server) ⭐ 4,356 | 🐛 31 | 🌐 Go | 📅 2026-02-12 \[Go] - an open source customer data infrastructure (segment, mparticle alternative).
* [databus](https://github.com/linkedin/databus) ⭐ 3,680 | 🐛 40 | 🌐 Java | 📅 2023-09-28 \[Java] - Linkedin's source-agnostic distributed change data capture system.
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,383 | 🐛 18 | 🌐 Python | 📅 2026-02-12 \[Python] - CLI tool to copy data between any source and destination with a single command. Supports 50+ connectors including databases, SaaS apps, and data warehouses.
* [flume](https://github.com/apache/flume) ⭐ 2,559 | 🐛 91 | 🌐 Java | 📅 2024-10-10 \[Java] - distributed, reliable, and available service for efficiently collecting, aggregating, and moving large amounts of log data.
* [NATS streaming](https://github.com/nats-io/nats-streaming-server) ⚠️ Archived \[Go] - fast disk-backed messaging solution
* [Bruin](https://github.com/bruin-data/bruin) ⭐ 1,364 | 🐛 33 | 🌐 Go | 📅 2026-02-12 \[Go] - End-to-end data pipeline tool combining ingestion from 50+ sources, SQL/Python transformations, and built-in data quality checks in a single CLI.
...
* [River](https://github.com/online-ml/river) ⭐ 5,710 | 🐛 115 | 🌐 Python | 📅 2026-02-09 \[Python] - online machine learning library.
* [DataSketches](https://github.com/DataSketches/sketches-core) ⭐ 945 | 🐛 7 | 🌐 Java | 📅 2026-02-11 \[Java] - sketches library from Yahoo!.
...
* [pipelinedb](https://github.com/pipelinedb/pipelinedb) ⭐ 2,656 | 🐛 133 | 🌐 C | 📅 2022-02-20 \[C] - An open-source relational database that runs SQL queries continuously on streams, incrementally storing results in tables.
* [Proton](https://github.com/timeplus-io/proton) ⭐ 2,133 | 🐛 90 | 🌐 C++ | 📅 2026-02-12 \[C++] - A unified streaming and historical data analytics database in a single binary, powered by ClickHouse.
...
* [ksqlDB](https://github.com/confluentinc/ksql) ⭐ 290 | 🐛 1,311 | 🌐 Java | 📅 2026-02-13 \[Java] - A cloud-native, source-available [database](https://ksqldb.io/) purpose-built for stream processing applications
...
* [akka](https://github.com/akka/akka) ⭐ 13,265 | 🐛 903 | 🌐 Scala | 📅 2026-02-12 \[Scala] - toolkit and runtime for building highly concurrent, distributed, and resilient message-driven application on the JVM.
* [aeron](https://github.com/real-logic/Aeron) ⭐ 8,444 | 🐛 16 | 🌐 Java | 📅 2026-02-07 \[Java/C++] - efficient reliable unicast and multicast message transport.
* [pulsar](https://github.com/quantmind/pulsar/) ⚠️ Archived \[Python] - Actor based event driven concurrent framework for Python.
* [Apache Pekko](https://github.com/apache/incubator-pekko) ⭐ 1,526 | 🐛 201 | 🌐 Scala | 📅 2026-02-10 \[Scala, Java] - Fork of Akka 2.6.x, prior to the Akka project's adoption of the Business Source License.
...
* [Nussknacker](https://github.com/TouK/nussknacker) ⭐ 709 | 🐛 68 | 🌐 Scala | 📅 2026-02-12 \[Scala] - A visual tool to define and run real-time decision algorithms.
