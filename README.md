## Awesome Streaming  [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 436,832 | 🐛 67 | 📅 2026-01-28 [![Build Status](https://github.com/manuzhang/awesome-streaming/workflows/build/badge.svg)](https://github.com/manuzhang/awesome-streaming/actions) ⭐ 2,953 | 🐛 5 | 📅 2026-02-09

A curated list of awesome [streaming (stream processing)](http://radar.oreilly.com/2015/08/the-world-beyond-batch-streaming-101.html) frameworks, applications, readings and other resources. Inspired by [other awesome projects](https://github.com/sindresorhus/awesome) ⭐ 436,832 | 🐛 67 | 📅 2026-01-28.
...
* [Pathway](https://github.com/pathwaycom/pathway) ⭐ 59,331 | 🐛 30 | 🌐 Python | 📅 2026-02-10 \[Python] - The fastest data processing engine supporting unified workflows for batch, streaming data, and LLM applications.
* [Apache Spark Streaming](https://github.com/apache/spark) ⭐ 42,800 | 🐛 248 | 🌐 Scala | 📅 2026-02-12 \[Scala] - makes it easy to build scalable fault-tolerant streaming applications.
* [Apache Flink](https://github.com/apache/flink) ⭐ 25,780 | 🐛 295 | 🌐 Java | 📅 2026-02-12 \[Java] - system for high-throughput, low-latency data stream processing that supports stateful computation, data-driven windowing semantics and iterative stream processing.
* [RisingWave](https://github.com/risingwavelabs/risingwave) ⭐ 8,786 | 🐛 1,426 | 🌐 Rust | 📅 2026-02-12 \[Rust] - A PostgreSQL-compatible streaming database that is designed to build event-driven applications, real-time ETL pipelines, continuous analytics services, and feature stores for AI applications. It excels in extracting fresh and consistent insights from real-time event streams, database CDC, and time series data within sub-seconds. It unifies streaming and batch processing, enabling users to ingest, join, and analyze both live and historical data at a cloud scale.
...
* [Numaflow](https://github.com/numaproj/numaflow) ⭐ 2,435 | 🐛 251 | 🌐 Rust | 📅 2026-02-11 \[Java/Python/Go/Rust] - Kubernetes native stream processing platform with language agnostic framework. Scalable and cost-efficient
...
* [Apache Ballista](https://github.com/apache/arrow-ballista) ⭐ 1,969 | 🐛 116 | 🌐 Rust | 📅 2026-02-12 \[Rust] - distributed compute platform powered by Apache Arrow.
...
* [ArkFlow](https://github.com/arkflow-rs/arkflow) ⭐ 1,249 | 🐛 29 | 🌐 Rust | 📅 2026-02-09 \[Rust] - High-performance Rust stream processing engine, providing powerful data stream processing capabilities, supporting multiple input/output sources and processors.
...
* [NebulaStream](https://github.com/nebulastream/nebulastream) ⭐ 75 | 🐛 189 | 🌐 C++ | 📅 2026-02-11 \[C++] - High-performance, general-purpose, end-to-end data-management system for cloud-edge-sensor environments.
...
* [Mediapipe](https://github.com/google/mediapipe) ⭐ 33,748 | 🐛 605 | 🌐 C++ | 📅 2026-02-04 - Cross-platform, customizable ML solutions for live and streaming media.
* [Apache Kafka Streams](https://github.com/apache/kafka) ⭐ 31,872 | 🐛 277 | 🌐 Java | 📅 2026-02-12 \[Java] - lightweight stream processing library included in Apache Kafka (since 0.10 version).
* [Akka Streams](https://github.com/akka/akka) ⭐ 13,265 | 🐛 903 | 🌐 Scala | 📅 2026-02-11 \[Scala] - stream processing library on Akka Actors.
* [Benthos](https://github.com/Jeffail/benthos) ⭐ 8,585 | 🐛 555 | 🌐 Go | 📅 2026-02-12 \[Go] - Benthos is a high performance and resilient message streaming service, able to connect various sources and sinks and perform arbitrary actions, transformations and filters on payloads
...
* [FS2(prev. 'Scalaz-Stream')](https://github.com/functional-streams-for-scala/fs2) ⭐ 2,441 | 🐛 131 | 🌐 Scala | 📅 2026-02-11 \[Scala] - Compositional, streaming I/O library for Scala.
...
* [Quix Streams](https://github.com/quixio/quix-streams) ⭐ 1,519 | 🐛 24 | 🌐 Python | 📅 2026-02-11 \[Python] - a streaming library originally designed for the McLaren Formula 1 racing team that can process high volumes of time-series data with up to nanosecond precision using Apache Kafka as a message broker.
...
* [storm-crawler](https://github.com/DigitalPebble/storm-crawler) ⭐ 962 | 🐛 29 | 🌐 Java | 📅 2026-02-09 \[Java] - Web crawler SDK based on Apache Storm.
* [Zilla](https://github.com/aklivity/zilla) ⭐ 676 | 🐛 169 | 🌐 Java | 📅 2026-02-11 \[Java] - Cross-platform, API gateway built for event-driven architectures and streaming that supports standard protocols such as HTTP, SSE, gRPC, MQTT and the native Kafka protocol.
...
* [Apache StreamPipes](https://github.com/apache/incubator-streampipes) ⭐ 709 | 🐛 149 | 🌐 Java | 📅 2026-02-11 \[Java] - a self-service (Industrial) IoT toolbox to enable non-technical users to connect, analyze and explore IoT data streams.
...
* [Apache Beam](https://github.com/apache/beam) ⭐ 8,483 | 🐛 4,161 | 🌐 Java | 📅 2026-02-12 \[Java, Python, SQL, Scala, Go] - unified model and set of language-specific SDKs for defining and executing data processing workflows, and also data ingestion and integration flows, supporting Enterprise Integration Patterns (EIPs) and Domain Specific Languages (DSLs), open sourced by Google.
...
* [Apache Kafka](https://github.com/apache/kafka) ⭐ 31,872 | 🐛 277 | 🌐 Java | 📅 2026-02-12 \[Scala/Java] - distributed, partitioned, replicated commit log service, which provides the functionality of a messaging system, but with a unique design.
...
* [Apache RocketMQ](https://github.com/apache/rocketmq) ⭐ 22,334 | 🐛 283 | 🌐 Java | 📅 2026-02-12 \[Java] - distributed messaging and streaming platform with low latency, high performance and reliability, trillion-level capacity and flexible scalability.
* [Apache Pulsar](https://github.com/apache/incubator-pulsar) ⭐ 15,086 | 🐛 1,638 | 🌐 Java | 📅 2026-02-12 \[Java] - distributed pub-sub messaging platform with a very flexible messaging model and an intuitive client API.
* [Redpanda](https://github.com/redpanda-data/redpanda) ⭐ 11,713 | 🐛 664 | 🌐 C++ | 📅 2026-02-12 \[C++] - Redpanda is Kafka compatible, ZooKeeper-free, JVM-free and source available.
* [AutoMQ](https://github.com/AutoMQ/automq) ⭐ 9,485 | 🐛 84 | 🌐 Java | 📅 2026-02-12 \[Scala/Java] - cloud-first alternative to Kafka by decoupling durability to S3 and EBS. 100% Kafka compatible. 10x cost-effective. Autoscale in seconds. Single-digit ms latency.
* [fluvio](https://github.com/infinyon/fluvio) ⭐ 5,166 | 🐛 138 | 🌐 Rust | 📅 2026-02-11 \[Rust/WASM] - Real-time programmable data streaming platform with in-line computation capabilities.
* [RudderStack](https://github.com/rudderlabs/rudder-server) ⭐ 4,356 | 🐛 30 | 🌐 Go | 📅 2026-02-12 \[Go] - an open source customer data infrastructure (segment, mparticle alternative).
...
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,383 | 🐛 18 | 🌐 Python | 📅 2026-02-11 \[Python] - CLI tool to copy data between any source and destination with a single command. Supports 50+ connectors including databases, SaaS apps, and data warehouses.
...
* [Bruin](https://github.com/bruin-data/bruin) ⭐ 1,364 | 🐛 35 | 🌐 Go | 📅 2026-02-11 \[Go] - End-to-end data pipeline tool combining ingestion from 50+ sources, SQL/Python transformations, and built-in data quality checks in a single CLI.
...
* [brooklin](https://github.com/linkedin/Brooklin/) ⭐ 953 | 🐛 34 | 🌐 Java | 📅 2026-02-04 \[Java] - a distributed system intended for streaming data between various heterogeneous source and destination systems with high reliability and throughput at scale from Linkedin (replaced databus).
...
* [River](https://github.com/online-ml/river) ⭐ 5,707 | 🐛 116 | 🌐 Python | 📅 2026-02-09 \[Python] - online machine learning library.
...
* [Proton](https://github.com/timeplus-io/proton) ⭐ 2,133 | 🐛 90 | 🌐 C++ | 📅 2026-02-11 \[C++] - A unified streaming and historical data analytics database in a single binary, powered by ClickHouse.
...
* [ksqlDB](https://github.com/confluentinc/ksql) ⭐ 289 | 🐛 1,311 | 🌐 Java | 📅 2026-02-12 \[Java] - A cloud-native, source-available [database](https://ksqldb.io/) purpose-built for stream processing applications
...
* [akka](https://github.com/akka/akka) ⭐ 13,265 | 🐛 903 | 🌐 Scala | 📅 2026-02-11 \[Scala] - toolkit and runtime for building highly concurrent, distributed, and resilient message-driven application on the JVM.
...
* [Apache Pekko](https://github.com/apache/incubator-pekko) ⭐ 1,526 | 🐛 200 | 🌐 Scala | 📅 2026-02-10 \[Scala, Java] - Fork of Akka 2.6.x, prior to the Akka project's adoption of the Business Source License.
...
* [Nussknacker](https://github.com/TouK/nussknacker) ⭐ 709 | 🐛 69 | 🌐 Scala | 📅 2026-02-11 \[Scala] - A visual tool to define and run real-time decision algorithms.
