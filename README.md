## Awesome Streaming  [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 435,650 | 🐛 67 | 📅 2026-01-28 [![Build Status](https://github.com/manuzhang/awesome-streaming/workflows/build/badge.svg)](https://github.com/manuzhang/awesome-streaming/actions) ⭐ 2,952 | 🐛 5 | 📅 2025-07-24

A curated list of awesome [streaming (stream processing)](http://radar.oreilly.com/2015/08/the-world-beyond-batch-streaming-101.html) frameworks, applications, readings and other resources. Inspired by [other awesome projects](https://github.com/sindresorhus/awesome) ⭐ 435,650 | 🐛 67 | 📅 2026-01-28.
...
* [Pathway](https://github.com/pathwaycom/pathway) ⭐ 59,284 | 🐛 31 | 🌐 Python | 📅 2026-02-06 \[Python] - The fastest data processing engine supporting unified workflows for batch, streaming data, and LLM applications.
* [Apache Spark Streaming](https://github.com/apache/spark) ⭐ 42,764 | 🐛 251 | 🌐 Scala | 📅 2026-02-07 \[Scala] - makes it easy to build scalable fault-tolerant streaming applications.
* [Apache Flink](https://github.com/apache/flink) ⭐ 25,765 | 🐛 273 | 🌐 Java | 📅 2026-02-07 \[Java] - system for high-throughput, low-latency data stream processing that supports stateful computation, data-driven windowing semantics and iterative stream processing.
* [RisingWave](https://github.com/risingwavelabs/risingwave) ⭐ 8,773 | 🐛 1,428 | 🌐 Rust | 📅 2026-02-07 \[Rust] - A PostgreSQL-compatible streaming database that is designed to build event-driven applications, real-time ETL pipelines, continuous analytics services, and feature stores for AI applications. It excels in extracting fresh and consistent insights from real-time event streams, database CDC, and time series data within sub-seconds. It unifies streaming and batch processing, enabling users to ingest, join, and analyze both live and historical data at a cloud scale.
* [Faust](https://github.com/robinhood/faust) ⭐ 6,834 | 🐛 276 | 🌐 Python | 📅 2024-07-27 \[Python] - stream processing library, porting the ideas from Kafka Streams to Python
...
* [Numaflow](https://github.com/numaproj/numaflow) ⭐ 2,434 | 🐛 244 | 🌐 Rust | 📅 2026-02-07 \[Java/Python/Go/Rust] - Kubernetes native stream processing platform with language agnostic framework. Scalable and cost-efficient
...
* [Apache Ballista](https://github.com/apache/arrow-ballista) ⭐ 1,965 | 🐛 115 | 🌐 Rust | 📅 2026-02-05 \[Rust] - distributed compute platform powered by Apache Arrow.
* [Bytewax](https://github.com/bytewax/bytewax) ⭐ 1,951 | 🐛 40 | 🌐 Python | 📅 2025-03-27 \[Python] - data parallel, distributed, stateful stream processing framework.
* [Kuiper](https://github.com/emqx/kuiper) ⭐ 1,678 | 🐛 46 | 🌐 Go | 📅 2026-02-02 \[Golang] - An edge lightweight IoT data analytics/streaming software implemented by Golang, and it can be run at all kinds of resource-constrained edge devices.
* [Wallaroo](https://github.com/WallarooLabs/wallaroo) ⭐ 1,486 | 🐛 346 | 🌐 Pony | 📅 2021-04-06 \[Python] - A fast, stream-processing framework. Wallaroo makes it easy to react to data in real-time. By eliminating infrastructure complexity, going from prototype to production has never been simpler.
* [mantis](https://github.com/Netflix/mantis) ⭐ 1,457 | 🐛 80 | 🌐 Java | 📅 2026-02-03 \[Java] - Netflix's platform to build an ecosystem of realtime stream processing applications
...
* [ArkFlow](https://github.com/arkflow-rs/arkflow) ⭐ 1,247 | 🐛 29 | 🌐 Rust | 📅 2026-02-06 \[Rust] - High-performance Rust stream processing engine, providing powerful data stream processing capabilities, supporting multiple input/output sources and processors.
...
* [NebulaStream](https://github.com/nebulastream/nebulastream) ⭐ 75 | 🐛 182 | 🌐 C++ | 📅 2026-02-07 \[C++] - High-performance, general-purpose, end-to-end data-management system for cloud-edge-sensor environments.
...
* [Mediapipe](https://github.com/google/mediapipe) ⭐ 33,674 | 🐛 605 | 🌐 C++ | 📅 2026-02-04 - Cross-platform, customizable ML solutions for live and streaming media.
* [Apache Kafka Streams](https://github.com/apache/kafka) ⭐ 31,849 | 🐛 270 | 🌐 Java | 📅 2026-02-07 \[Java] - lightweight stream processing library included in Apache Kafka (since 0.10 version).
* [Akka Streams](https://github.com/akka/akka) ⭐ 13,262 | 🐛 900 | 🌐 Scala | 📅 2026-02-06 \[Scala] - stream processing library on Akka Actors.
* [Benthos](https://github.com/Jeffail/benthos) ⭐ 8,577 | 🐛 550 | 🌐 Go | 📅 2026-02-07 \[Go] - Benthos is a high performance and resilient message streaming service, able to connect various sources and sinks and perform arbitrary actions, transformations and filters on payloads
* [FastStream](https://github.com/airtai/faststream) ⭐ 4,938 | 🐛 114 | 🌐 Python | 📅 2026-02-05 \[Python] - powerful and easy-to-use Python library simplifying the process of writing producers and consumers for message queues, handling all the parsing, networking and documentation generation automatically. Supports multiple protocols such as Apache Kafka, RabbitMQ and alike.
...
* [FS2(prev. 'Scalaz-Stream')](https://github.com/functional-streams-for-scala/fs2) ⭐ 2,440 | 🐛 129 | 🌐 Scala | 📅 2026-02-04 \[Scala] - Compositional, streaming I/O library for Scala.
...
* [YoMo](https://github.com/yomorun/yomo) ⭐ 1,880 | 🐛 3 | 🌐 Go | 📅 2026-02-03 \[Go] - An open source Streaming Serverless Framework for building Low-latency Geo-distributed system. YoMo Built atop [QUIC Transport Protocol](https://en.wikipedia.org/wiki/QUIC) and Functional Reactive Programming interface.
* [Quix Streams](https://github.com/quixio/quix-streams) ⭐ 1,518 | 🐛 23 | 🌐 Python | 📅 2026-02-02 \[Python] - a streaming library originally designed for the McLaren Formula 1 racing team that can process high volumes of time-series data with up to nanosecond precision using Apache Kafka as a message broker.
...
* [Streamiz](https://github.com/LGouellec/kafka-streams-dotnet) ⭐ 524 | 🐛 25 | 🌐 C# | 📅 2026-01-26 \[C#] - a .Net Stream Processing Library for Apache Kafka
...
* [Streamline](https://github.com/hortonworks/streamline) ⭐ 166 | 🐛 123 | 🌐 Java | 📅 2023-08-27 \[Java] - Stream Analytics Framework by Hortonworks, designed as a wrapper around existing streaming solutions like Storm. Aimed to allow users to drag-and-drop streaming components to focus on business logic.
...
* [storm-crawler](https://github.com/DigitalPebble/storm-crawler) ⭐ 960 | 🐛 27 | 🌐 Java | 📅 2026-02-03 \[Java] - Web crawler SDK based on Apache Storm.
* [Zilla](https://github.com/aklivity/zilla) ⭐ 675 | 🐛 171 | 🌐 Java | 📅 2026-02-06 \[Java] - Cross-platform, API gateway built for event-driven architectures and streaming that supports standard protocols such as HTTP, SSE, gRPC, MQTT and the native Kafka protocol.
...
* [Apache StreamPipes](https://github.com/apache/incubator-streampipes) ⭐ 704 | 🐛 137 | 🌐 Java | 📅 2026-02-07 \[Java] - a self-service (Industrial) IoT toolbox to enable non-technical users to connect, analyze and explore IoT data streams.
...
* [Apache Beam](https://github.com/apache/beam) ⭐ 8,473 | 🐛 4,162 | 🌐 Java | 📅 2026-02-07 \[Java, Python, SQL, Scala, Go] - unified model and set of language-specific SDKs for defining and executing data processing workflows, and also data ingestion and integration flows, supporting Enterprise Integration Patterns (EIPs) and Domain Specific Languages (DSLs), open sourced by Google.
...
* [Apache Kafka](https://github.com/apache/kafka) ⭐ 31,849 | 🐛 270 | 🌐 Java | 📅 2026-02-07 \[Scala/Java] - distributed, partitioned, replicated commit log service, which provides the functionality of a messaging system, but with a unique design.
* [nsq](https://github.com/nsqio/nsq) ⭐ 25,924 | 🐛 73 | 🌐 Go | 📅 2025-07-13 \[Go] - realtime distributed messaging platform designed to operate at scale, handling billions of messages per day.
* [Apache RocketMQ](https://github.com/apache/rocketmq) ⭐ 22,328 | 🐛 276 | 🌐 Java | 📅 2026-02-06 \[Java] - distributed messaging and streaming platform with low latency, high performance and reliability, trillion-level capacity and flexible scalability.
* [Apache Pulsar](https://github.com/apache/incubator-pulsar) ⭐ 15,080 | 🐛 1,638 | 🌐 Java | 📅 2026-02-06 \[Java] - distributed pub-sub messaging platform with a very flexible messaging model and an intuitive client API.
* [Redpanda](https://github.com/redpanda-data/redpanda) ⭐ 11,688 | 🐛 662 | 🌐 C++ | 📅 2026-02-07 \[C++] - Redpanda is Kafka compatible, ZooKeeper-free, JVM-free and source available.
* [AutoMQ](https://github.com/AutoMQ/automq) ⭐ 9,468 | 🐛 80 | 🌐 Java | 📅 2026-02-06 \[Scala/Java] - cloud-first alternative to Kafka by decoupling durability to S3 and EBS. 100% Kafka compatible. 10x cost-effective. Autoscale in seconds. Single-digit ms latency.
* [fluvio](https://github.com/infinyon/fluvio) ⭐ 5,159 | 🐛 137 | 🌐 Rust | 📅 2026-02-05 \[Rust/WASM] - Real-time programmable data streaming platform with in-line computation capabilities.
* [RudderStack](https://github.com/rudderlabs/rudder-server) ⭐ 4,355 | 🐛 29 | 🌐 Go | 📅 2026-02-06 \[Go] - an open source customer data infrastructure (segment, mparticle alternative).
...
* [metaq](https://github.com/killme2008/Metamorphosis) ⭐ 1,333 | 🐛 49 | 🌐 Java | 📅 2020-04-07 \[Java] - Taobao's high available, high performance distributed messaging system
...
* [Gazette](https://github.com/gazette/core) ⭐ 785 | 🐛 24 | 🌐 Go | 📅 2026-02-06 \[golang] - Distributed streaming infrastructure built on cloud storage which makes it easy to mix and match batch and streaming paradigms.
...
* [River](https://github.com/online-ml/river) ⭐ 5,702 | 🐛 126 | 🌐 Python | 📅 2026-02-06 \[Python] - online machine learning library.
* [DataSketches](https://github.com/DataSketches/sketches-core) ⭐ 945 | 🐛 8 | 🌐 Java | 📅 2026-02-06 \[Java] - sketches library from Yahoo!.
* [streamDM](https://github.com/huawei-noah/streamDM) ⭐ 499 | 🐛 4 | 🌐 Scala | 📅 2023-04-16 \[Scala] - mining Big Data streams using Spark Streaming from Huawei.
...
* [Proton](https://github.com/timeplus-io/proton) ⭐ 2,133 | 🐛 89 | 🌐 C++ | 📅 2026-02-05 \[C++] - A unified streaming and historical data analytics database in a single binary, powered by ClickHouse.
...
* [ksqlDB](https://github.com/confluentinc/ksql) ⭐ 285 | 🐛 1,311 | 🌐 Java | 📅 2026-02-07 \[Java] - A cloud-native, source-available [database](https://ksqldb.io/) purpose-built for stream processing applications
...
* [streaming-benchmarks](https://github.com/yahoo/streaming-benchmarks) ⭐ 646 | 🐛 25 | 🌐 Jupyter Notebook | 📅 2023-12-17 \[Java] - Benchmarks for Low Latency (Streaming) solutions including Apache Storm, Apache Spark, Apache Flink, etc.
...
* [akka](https://github.com/akka/akka) ⭐ 13,262 | 🐛 900 | 🌐 Scala | 📅 2026-02-06 \[Scala] - toolkit and runtime for building highly concurrent, distributed, and resilient message-driven application on the JVM.
* [aeron](https://github.com/real-logic/Aeron) ⭐ 8,434 | 🐛 17 | 🌐 Java | 📅 2026-02-06 \[Java/C++] - efficient reliable unicast and multicast message transport.
* [pulsar](https://github.com/quantmind/pulsar/) ⚠️ Archived \[Python] - Actor based event driven concurrent framework for Python.
* [Apache Pekko](https://github.com/apache/incubator-pekko) ⭐ 1,526 | 🐛 205 | 🌐 Scala | 📅 2026-02-05 \[Scala, Java] - Fork of Akka 2.6.x, prior to the Akka project's adoption of the Business Source License.
...
* [Nussknacker](https://github.com/TouK/nussknacker) ⭐ 708 | 🐛 68 | 🌐 Scala | 📅 2026-02-05 \[Scala] - A visual tool to define and run real-time decision algorithms.
