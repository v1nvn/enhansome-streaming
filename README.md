## Awesome Streaming  [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 437,260 | 🐛 69 | 📅 2026-01-28 [![Build Status](https://github.com/manuzhang/awesome-streaming/workflows/build/badge.svg)](https://github.com/manuzhang/awesome-streaming/actions) ⭐ 2,953 | 🐛 5 | 📅 2026-02-09

A curated list of awesome [streaming (stream processing)](http://radar.oreilly.com/2015/08/the-world-beyond-batch-streaming-101.html) frameworks, applications, readings and other resources. Inspired by [other awesome projects](https://github.com/sindresorhus/awesome) ⭐ 437,260 | 🐛 69 | 📅 2026-01-28.
...
* [Pathway](https://github.com/pathwaycom/pathway) ⭐ 59,425 | 🐛 30 | 🌐 Python | 📅 2026-02-13 \[Python] - The fastest data processing engine supporting unified workflows for batch, streaming data, and LLM applications.
* [Apache Spark Streaming](https://github.com/apache/spark) ⭐ 42,810 | 🐛 255 | 🌐 Scala | 📅 2026-02-14 \[Scala] - makes it easy to build scalable fault-tolerant streaming applications.
* [Apache Flink](https://github.com/apache/flink) ⭐ 25,790 | 🐛 304 | 🌐 Java | 📅 2026-02-13 \[Java] - system for high-throughput, low-latency data stream processing that supports stateful computation, data-driven windowing semantics and iterative stream processing.
* [RisingWave](https://github.com/risingwavelabs/risingwave) ⭐ 8,790 | 🐛 1,431 | 🌐 Rust | 📅 2026-02-14 \[Rust] - A PostgreSQL-compatible streaming database that is designed to build event-driven applications, real-time ETL pipelines, continuous analytics services, and feature stores for AI applications. It excels in extracting fresh and consistent insights from real-time event streams, database CDC, and time series data within sub-seconds. It unifies streaming and batch processing, enabling users to ingest, join, and analyze both live and historical data at a cloud scale.
...
* [Numaflow](https://github.com/numaproj/numaflow) ⭐ 2,435 | 🐛 254 | 🌐 Rust | 📅 2026-02-14 \[Java/Python/Go/Rust] - Kubernetes native stream processing platform with language agnostic framework. Scalable and cost-efficient
...
* [NebulaStream](https://github.com/nebulastream/nebulastream) ⭐ 75 | 🐛 191 | 🌐 C++ | 📅 2026-02-13 \[C++] - High-performance, general-purpose, end-to-end data-management system for cloud-edge-sensor environments.
...
* [Mediapipe](https://github.com/google/mediapipe) ⭐ 33,770 | 🐛 606 | 🌐 C++ | 📅 2026-02-04 - Cross-platform, customizable ML solutions for live and streaming media.
* [Apache Kafka Streams](https://github.com/apache/kafka) ⭐ 31,888 | 🐛 279 | 🌐 Java | 📅 2026-02-13 \[Java] - lightweight stream processing library included in Apache Kafka (since 0.10 version).
* [Akka Streams](https://github.com/akka/akka) ⭐ 13,264 | 🐛 903 | 🌐 Scala | 📅 2026-02-13 \[Scala] - stream processing library on Akka Actors.
* [Benthos](https://github.com/Jeffail/benthos) ⭐ 8,586 | 🐛 560 | 🌐 Go | 📅 2026-02-13 \[Go] - Benthos is a high performance and resilient message streaming service, able to connect various sources and sinks and perform arbitrary actions, transformations and filters on payloads
...
* [FS2(prev. 'Scalaz-Stream')](https://github.com/functional-streams-for-scala/fs2) ⭐ 2,440 | 🐛 131 | 🌐 Scala | 📅 2026-02-11 \[Scala] - Compositional, streaming I/O library for Scala.
...
* [storm-crawler](https://github.com/DigitalPebble/storm-crawler) ⭐ 963 | 🐛 29 | 🌐 Java | 📅 2026-02-09 \[Java] - Web crawler SDK based on Apache Storm.
...
* [Apache Kafka](https://github.com/apache/kafka) ⭐ 31,888 | 🐛 279 | 🌐 Java | 📅 2026-02-13 \[Scala/Java] - distributed, partitioned, replicated commit log service, which provides the functionality of a messaging system, but with a unique design.
...
* [Apache RocketMQ](https://github.com/apache/rocketmq) ⭐ 22,334 | 🐛 279 | 🌐 Java | 📅 2026-02-13 \[Java] - distributed messaging and streaming platform with low latency, high performance and reliability, trillion-level capacity and flexible scalability.
* [Apache Pulsar](https://github.com/apache/incubator-pulsar) ⭐ 15,087 | 🐛 1,644 | 🌐 Java | 📅 2026-02-13 \[Java] - distributed pub-sub messaging platform with a very flexible messaging model and an intuitive client API.
* [Redpanda](https://github.com/redpanda-data/redpanda) ⭐ 11,719 | 🐛 668 | 🌐 C++ | 📅 2026-02-13 \[C++] - Redpanda is Kafka compatible, ZooKeeper-free, JVM-free and source available.
* [AutoMQ](https://github.com/AutoMQ/automq) ⭐ 9,500 | 🐛 84 | 🌐 Java | 📅 2026-02-13 \[Scala/Java] - cloud-first alternative to Kafka by decoupling durability to S3 and EBS. 100% Kafka compatible. 10x cost-effective. Autoscale in seconds. Single-digit ms latency.
* [fluvio](https://github.com/infinyon/fluvio) ⭐ 5,167 | 🐛 139 | 🌐 Rust | 📅 2026-02-11 \[Rust/WASM] - Real-time programmable data streaming platform with in-line computation capabilities.
* [RudderStack](https://github.com/rudderlabs/rudder-server) ⭐ 4,357 | 🐛 32 | 🌐 Go | 📅 2026-02-13 \[Go] - an open source customer data infrastructure (segment, mparticle alternative).
...
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,384 | 🐛 18 | 🌐 Python | 📅 2026-02-13 \[Python] - CLI tool to copy data between any source and destination with a single command. Supports 50+ connectors including databases, SaaS apps, and data warehouses.
...
* [brooklin](https://github.com/linkedin/Brooklin/) ⭐ 954 | 🐛 34 | 🌐 Java | 📅 2026-02-04 \[Java] - a distributed system intended for streaming data between various heterogeneous source and destination systems with high reliability and throughput at scale from Linkedin (replaced databus).
...
* [River](https://github.com/online-ml/river) ⭐ 5,712 | 🐛 115 | 🌐 Python | 📅 2026-02-09 \[Python] - online machine learning library.
* [DataSketches](https://github.com/DataSketches/sketches-core) ⭐ 946 | 🐛 7 | 🌐 Java | 📅 2026-02-11 \[Java] - sketches library from Yahoo!.
...
* [ksqlDB](https://github.com/confluentinc/ksql) ⭐ 290 | 🐛 1,312 | 🌐 Java | 📅 2026-02-14 \[Java] - A cloud-native, source-available [database](https://ksqldb.io/) purpose-built for stream processing applications
...
* [akka](https://github.com/akka/akka) ⭐ 13,264 | 🐛 903 | 🌐 Scala | 📅 2026-02-13 \[Scala] - toolkit and runtime for building highly concurrent, distributed, and resilient message-driven application on the JVM.
* [aeron](https://github.com/real-logic/Aeron) ⭐ 8,443 | 🐛 16 | 🌐 Java | 📅 2026-02-07 \[Java/C++] - efficient reliable unicast and multicast message transport.
* [pulsar](https://github.com/quantmind/pulsar/) ⚠️ Archived \[Python] - Actor based event driven concurrent framework for Python.
* [Apache Pekko](https://github.com/apache/incubator-pekko) ⭐ 1,527 | 🐛 201 | 🌐 Scala | 📅 2026-02-10 \[Scala, Java] - Fork of Akka 2.6.x, prior to the Akka project's adoption of the Business Source License.
